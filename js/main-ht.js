...
Theme URI: http://bluminethemes.com/preview/themeforest/html/noli/
...
(function($) {
	...
	function backPage() {
		...
		if(target === 'home' || target === ''){
			$('.navbar-brand.open-home-btn').trigger('click');
	...
	function initPageBackground() {
		...
		// Youtube Video List Background
		if($('body').hasClass('youtube-list-background')) {
